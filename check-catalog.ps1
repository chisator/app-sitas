...
Write-Host "exercise_catalog schema:"
$schema.definitions.exercise_catalog.properties.psobject.properties | Select-Object Name | ForEach-Object { Write-Host $_.Name }
